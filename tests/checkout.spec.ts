...
import { goToShop, dismissAuthPromoModal, findCheapestCard, addToCartWithRetry, openCart, AUTH_FILE } from './helpers';
...
test.describe('Đã đăng nhập', () => {
  // Dùng lại phiên đăng nhập đã tạo sẵn ở global-setup.ts thay vì tự đăng nhập lại
